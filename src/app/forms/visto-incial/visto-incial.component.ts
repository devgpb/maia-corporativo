...
export class VistoIncialComponent {
  ...
  private initializeForm(): FormGroup {
    ...
    group['quantidadeTubos'] = [null, [Validators.required]];
    group['quantidadeConexoes'] = [null, [Validators.required]];
    group['comprimentoAterramento'] = [null, [Validators.required]];
    group['metragemCabeamento'] = [null, [Validators.required]];

    group['fotoRelogio'] = [null, [Validators.required]];
    group['fotoTelhado'] = [null, [Validators.required]];
    group['fotoDisjuntor'] = [null, [Validators.required]];
  ...
  onSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      this.pedidosService.vistoriaInicial(formData).subscribe(_ => {
        Swal.close();
